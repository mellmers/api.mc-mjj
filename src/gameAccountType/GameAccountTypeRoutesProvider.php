...
class GameAccountTypeRoutesProvider implements ControllerProviderInterface
{
    ...
    public function connect(Application $app)
    {
         ...
         *         @SWG\Schema(
         *          type="array",
         *          @SWG\Items(ref="#/definitions/GameAccountType"))
         *         )
         *     )
         * )
         */
         ...
         *     tags={"gameAccountType"},
         *     @SWG\Response(response="200", description="The GameAccountType with the specified ID", @SWG\Schema(ref="#/definitions/GameAccountType"))
         * )
         */
         ...
         *     @SWG\Response(response="200", description="The created GameAccountType", @SWG\Schema(ref="#/definitions/GameAccountType"))
         * )
         *
         */
